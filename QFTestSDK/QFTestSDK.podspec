...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/QFTestSDK"
  ...
  # Or just: spec.author    = "Ben"
  # spec.authors            = { "Ben" => "ben@quickfi.com" }
  ...
  spec.source       = { :git => "https://github.com/BstaffanUB/ShareAndCare.git", :tag => "#{spec.version}" }
